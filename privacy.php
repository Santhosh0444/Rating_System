...
<body>
    ...
    <main class="main">
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Rating System, the software program provided by the Company.
                </p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Rating System.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Rating System, accessible from [rating system](rating system)</p>
            </li>
            <li>
        ...
        <p>While using Our Application, in order to provide features of Our Application, We may collect, with Your prior
            permission:</p>
        <ul>
            <li><p>Pictures and other information from your Device's camera and photo library</p></li>
        </ul>
        ...
        <ul>
            <li><p><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can
                ...
                Your browser setting so that it will refuse Cookies, our Service may use Cookies.</p></li>
            <li><p><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small
                ...
                section and verifying system and server integrity).</p></li>
        </ul>
        ...
        <ul>
            <li>
                <p><strong>With Service Providers:</strong> We may share Your personal information with Service
                    Providers
                    to monitor and analyze the use of our Service, to contact You.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we
            ...
            <li>
                <p><strong>With business partners:</strong> We may share Your information with Our business partners to
        ...
        <ul>
            <li>
                <p>By email: santhoshyadav116@gmail.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: [Rating System](Rating System)</p>
            </li>
        </ul>
    </main>
</body>
